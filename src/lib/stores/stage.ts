		...
		collisionObjects: [
			{
				...
				opacity: 0.5,
				points: [0, 0, 300, 0, 240, 30, 210, 60, 180, 120, 0, 120],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [120, 240, 180, 240, 180, 300, 120, 300],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [120, 420, 180, 420, 180, 480, 120, 480],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [120, 600, 180, 600, 180, 660, 120, 660],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [120, 780, 180, 780, 180, 840, 120, 840],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [0, 960, 180, 960, 180, 1020, 120, 1020, 120, 1380, 0, 1380],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [1080, 120, 900, 120, 870, 60, 840, 30, 780, 0, 1080, 0],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 240, 960, 240, 960, 300, 900, 300],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 420, 960, 420, 960, 480, 900, 480],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 600, 960, 600, 960, 660, 900, 660],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 780, 960, 780, 960, 840, 900, 840],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 960, 1080, 960, 1080, 1380, 960, 1380, 960, 1020, 900, 1020],
				stroke: "none",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [
					120, 1020, 240, 1020, 300, 960, 360, 930, 480, 900, 600, 900, 720, 930, 780, 960, 840, 1020, 960, 1020, 840, 1020, 780, 960, 720,
					930, 600, 900, 480, 900, 360, 930, 300, 960, 240, 1020
				],
				stroke: "none",
				strokeWidth: 0
			}
		...
		zones: [
			{
				...
				opacity: 0.5,
				points: [
					120, 1020, 240, 1020, 300, 960, 360, 930, 480, 900, 600, 900, 720, 930, 780, 960, 840, 1020, 960, 1020, 960, 1380, 120, 1380
				],
				stroke: "black",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 960, 900, 840, 1080, 840, 1080, 960],
				stroke: "black",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [0, 120, 180, 120, 180, 960, 0, 960],
				stroke: "black",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [900, 120, 1080, 120, 1080, 840, 900, 840],
				stroke: "black",
				strokeWidth: 0
			},
			{
				...
				opacity: 0.5,
				points: [600, 0, 600, 30, 480, 30, 480, 0],
				stroke: "black",
				strokeWidth: 0
			}
		]
