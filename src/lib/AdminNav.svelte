...
>	
	...
	>
		<button
			type="submit"
			class="flex flex-row flex-nowrap justify-between items-center w-52 group py-1 px-3"
		>
			<div class="flex flex-col">
				<p class="text-text-600 text-left leading-4">Administrator</p>
				<p class="text-text-400 text-sm text-left group-hover:text-red-500">
					Kliknutím sa odhlasíte
				</p>
			</div>
		</button>
	</form>
...
<aside
	class="w-60 h-screen bg-background-800 fixed top-0 left-0 z-50 overflow-clip duration-200 ease-in-out"
>
	<div class="gap-1 flex flex-col justify-between h-full">
		<div class="flex flex-col gap-2 pb-2 h-full">
			...
			<div class="pl-4 mb-8">
				<p
					class="uppercase text-text-500 font-semibold px-2 text-sm mb-2 pointer-events-none select-none"
				>
					hlavné
				</p>
			...
			<div class="pl-4 mb-8">
				...
				<a class="nav-link" href="/admin/settings/stage">
					<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-grid-3x3"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 8h18" /><path d="M3 16h18" /><path d="M8 3v18" /><path d="M16 3v18" /></svg>
					<p>Sála</p>
				</a>
			</div>
		</div>
