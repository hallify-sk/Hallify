					...
					<table class="w-full border-collapse">
						...
						<tbody>
							...
							<tr class="event-table-row">
								...
								<td class="event-table-long-text">Svadba - Test</td>
								<td class="px-4 py-3 text-sm text-text-4">12.12.2021</td>
								<td class="px-4 py-3 text-sm">
									<span class="px-2 py-1 text-red-600 rounded bg-red-300/40"> Zrušená </span>
								</td>
							</tr>
							<tr class="event-table-row">
								<td>
								...
								<td class="event-table-long-text">Narodeniny jubileum 50.</td>
								<td class="px-4 py-3 text-sm text-text-4">12.12.2021</td>
								<td class="px-4 py-3 text-sm">
									<span class="px-2 py-1 text-green-600 rounded bg-green-300/40">Naplánovaná</span>
								</td>
							</tr>
							<tr class="event-table-row">
								<td>
...
<Dialog bind:open={showEventDialog}>
	...
	<form class="flex flex-col w-full" action="">
		<div class="flex flex-col p-4">
			...
			<TextInput name="názov" id="nazov" />
			<label for="" class="mt-4 text-sm text-slate-800">Názov</label>
			<TextInput name="nazov" id="nazov2" />
		</div>
